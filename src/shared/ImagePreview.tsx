      ...
      {createPortal(
        ...
        >
          <button
            ...
            className="auto top-2 right-2 w-8 h-8 pb-0.5 flex items-center justify-center mx-auto absolute z-10 text-white hover:text-gray-200 hover:outline-1 rounded-full"
            aria-label="Close"
          >
